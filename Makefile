...
message-delta:
	python3 -B infra/db/message_delta_suite.py delta

message-delta-query-plan:
	python3 -B infra/db/message_delta_suite.py query-plan

message-delta-recovery:
	python3 -B infra/db/message_delta_suite.py recovery
